...
<div class="wrapper_admin">
    ...
    <tr><td><font color="white">Voter ID:</font>&nbsp;&nbsp;</td><td><input type="text"  name="UserName" class="UserName_hover"></td></tr>
	<tr>
...
$login_query=mysqli_query($conn,"select * from voters where Username='$UserName' and Password='$Password' and Status='Unvoted' ") or die(mysqli_error());
$login_query3=mysqli_query($conn,"select * from voters where Username='$UserName' and Password='$Password' and Status='Unvoted' ") or die(mysqli_error());
$login_query4=mysqli_query($conn,"select * from voters where Username='$UserName' and Password='$Password' and Status='Unvoted' ") or die(mysqli_error());
$login_query5=mysqli_query($conn,"select * from voters where Username='$UserName' and Password='$Password' and Status='Unvoted' ") or die(mysqli_error());
//
