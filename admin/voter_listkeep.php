...
<tr class="del<?php echo $id ?>">	
    ...
    <td align="center"><a class="btn btn-Success" href="edit_voter.php<?php echo '?id='.$id; ?>">  <i class="icon-trash icon-large"></i>&nbsp;Edit</a>
    <td align="center"><a class="btn btn-info"  data-toggle="modal" href="#<?php echo $id; ?>" >  <i class="icon-trash icon-large"></i>&nbsp;view</a>
...
<h1>Candidate Information</h1>
      ...
      <p>
	  Voters ID:&nbsp;<?php echo $voter_rows['vid'];  ?>
	  </p>
      <p>
	  ...
	  <p>
	  Mobile No:&nbsp;<?php echo $voter_rows['mobileno'];  ?>
	  </p>	
