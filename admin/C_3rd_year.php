...
<div class="navbar">
   ...
   <li><a href="Canvassing_report.php"><font color="white">All</font></a></li>
    ...
    <li  class="active"><a href="C_3rd_year.php"><font color="white">Financal Secretary</font></a></li>
...
<?php $candidate_query=mysqli_query($conn,"select  * from candidate where Position='Financial Secretary'");
...
<tr class="del<?php echo $id ?>">
	...
	<a class="btn btn-Success" href="cvoter_list.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;View Voters</a>&nbsp;
    </td>
</td>	
