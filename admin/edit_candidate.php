...
$image= addslashes(file_get_contents($_FILES['image']['tmp_name']));
	...
	$image_size= getimagesize($_FILES['image']['tmp_name']);
			...
			$location1=",Photo1 = 'admin/upload/" . $_FILES["image"]["name"] ."'";
			
			}
			
			mysqli_query($conn,"update candidate set FirstName='$rfirstname',LastName='$rlastname',Gender='$rgender',year='$ryear',Position='$rposition',MiddleName='$rname',Party='$party' $location $location1  where CandidateID='$get_id'")or die(mysqli_query);
