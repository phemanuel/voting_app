...
<div class="navbar">
    ...
    <li  class="active"><a href="C_1st_year.php"><font color="white">General Secretary</font></a></li>
...
<?php $candidate_query=mysqli_query($conn,"select  * from candidate where Position='General Secretary'");
