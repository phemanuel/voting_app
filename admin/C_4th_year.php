...
<div class="navbar">
    ...
    <li  class="active"><a href="C_4th_year.php"><font color="white">P.R.O</font></a></li>
...
<?php $candidate_query=mysqli_query($conn,"select  * from candidate where Position='P.R.O'");
