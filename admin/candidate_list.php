...
<div class="navbar">
    ...
    <li><a href="candidate_for_vice-governor.php"><font color="white">Vice President</font></a></li>
    <li><a href="1st_year.php"><font color="white">General Secretary</font></a></li>
    <li><a href="2nd_year.php"><font color="white">Treasurer</font></a></li>
    <li><a href="3rd_year.php"><font color="white">Financal Secretary</font></a></li>
    <li><a href="4th_year.php"><font color="white">P.R.O</font></a></li>
...
<h1>Candidate Information</h1>
	  ...
	  <div class="pull-right-modal">
       <p>
	  Last Name:&nbsp;<?php echo $candidate_rows['LastName'];  ?>
	  </p>
	  <p>
	  First Name:&nbsp;<?php echo $candidate_rows['FirstName'];  ?>
	  </p>
	  
	  <p>
	  Middle Name:&nbsp;<?php echo $candidate_rows['MiddleName'];  ?>
	  </p>
	  <p>
